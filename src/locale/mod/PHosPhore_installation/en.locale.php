...
/* wrong secret */
$GLOBALS['locale']['mod']['phosphore_installation']['error']['wrong_secret'] = 'Cannot resume PHosPhore installation, incorrect secret, reload the page and put the correct secret (a new secret will be set)';
